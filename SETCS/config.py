...
def add_model_args(parser):
    ...
    data.add_argument('--use_tokenized_code', type='bool', default=False,
                      help='Use tokenized code as additional feature for feature representations')
    ...
    model.add_argument('--share_decoder_embeddings', type='bool', default=False,
                         help='Share decoder embeddings weight with softmax layer')
    model.add_argument('--coverage_attn', type='bool', default=False,
