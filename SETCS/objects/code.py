from SETCS.inputters.vocabulary import Vocabulary, BOS_WORD, EOS_WORD
...
class Code(object):
    ...
    @property
    def tokenized_tokens(self) -> list:
        return self._tokenized_tokens

    @tokenized_tokens.setter
    def tokenized_tokens(self, param: list) -> None:
        assert isinstance(param, list)
        self._tokenized_tokens = param
        self.form_src_vocab()
